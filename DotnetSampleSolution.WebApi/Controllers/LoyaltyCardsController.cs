...
namespace DotnetSampleSolution.WebApi.Controllers
{
    ...
    public class LoyaltyCardsController : ControllerBase
    {
        ...
        {
            IEnumerable<LoyaltyCardEntity> loyaltyCardEntities = await _unitOfWork.LoyaltyCardRepository.GetAllAsync();
        ...
        {
            LoyaltyCardEntity? loyaltyCardEntity = await _unitOfWork.LoyaltyCardRepository.GetByIdAsync(id);
